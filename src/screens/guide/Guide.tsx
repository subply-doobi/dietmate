...
// doobi Component
import {BtnCTA, Row, Col, StyledProps} from '../../shared/ui/styledConsts';
import {updateNotShowAgain} from '../../shared/utils/asyncStorage';
  ...
  const guidePageArray: IGuidePage[] = [
    {
      ...
      onboardingSource: require('../../shared/assets/onboardingLottie/onboardingCr.json'),
    },
    {
      step: 2,
      text: (
      ...
      onboardingSource: require('../../shared/assets/onboardingImg/onboarding1.png'),
    },
    {
      step: 3,
      text: (
      ...
      onboardingSourceType: 'img',
      onboardingSource: require('../../shared/assets/onboardingImg/autoMenu1.png'),
    },
    {
      step: 4,
      text: (
      ...
      onboardingSourceType: 'img',
      onboardingSource: require('../../shared/assets/onboardingImg/autoMenu2.png'),
    },
    {
      step: 5,
      text: (
      ...
      onboardingSourceType: 'img',
      onboardingSource: require('../../shared/assets/onboardingImg/manualAddDelete.png'),
    },
    {
      step: 6,
      text: (
      ...
      onboardingSourceType: 'img',
      onboardingSource: require('../../shared/assets/onboardingImg/onboarding5.png'),
    },
    {
      step: 7,
      text: (
      ...
      onboardingSourceType: 'img',
      onboardingSource: require('../../shared/assets/onboardingImg/remainNutrFilter.png'),
    },
  ];
