export const icons = {
  ...
  triangleDown_24: require(`./assets/icons/24_triangle_down.png`),
  triangleUp_24: require(`./assets/icons/24_triangle_up.png`),
  cart_36: require(`./assets/icons/36_cart.png`),
  cartActivated_36: require(`./assets/icons/36_cart_activated.png`),
  cartActivatedAdded_36: require(`./assets/icons/36_cart_activated_added.png`),
  cartAdded_36: require(`./assets/icons/36_cart_added.png`),
  ...
  plus_48: require(`./assets/icons/48_plus.png`),
  minus_48: require(`./assets/icons/48_minus.png`),
  kakaoPay: require(`./assets/icons/kakao_pay.png`),
  upDown_24: require(`./assets/icons/24_up_down.png`),
